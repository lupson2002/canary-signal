...
from data/canary.db - never re-runs the simulation.
"""
...
BAD = "#b0442f"
WEIGHT_COLORS = {
    "SPY": "#2a78d6", "QQQ": "#eb6834", "IWM": "#1baf7a", "EFA": "#eda100",
    "EEM": "#e87ba4", "VNQ": "#7a5c3e", "DBC": "#8a8d84", "GLD": "#d4a017",
    "IEF": "#3d5a73", "TLT": "#6b4fa0", "BIL": "#2f7d4f",
}
